export default function NationalTeamNotFound() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4">
      <div className="text-center space-y-6 max-w-md">
        ...
        <h1 className="text-2xl font-bold text-white">National Team Not Found</h1>
        <p className="text-slate-400">
          This national team doesn&apos;t exist or has been moved.
        </p>
        <a
          href="/international"
